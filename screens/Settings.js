        ...
        <View style={{marginTop:30}}>
            <Text style={
              colorScheme == "light"
                ...
                To enable or disable Dark mode, this can be done in the settings of your phone. Please restart the application if you change the settings.
            </Text>
        </View>
        {/* <View style={styles.language}>
